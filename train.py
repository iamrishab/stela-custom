...
if __name__ == '__main__':
    ...
    # dataset
    parser.add_argument('--train_dir', type=str, default='./datasets/data/icdar13_voc/')
    # training
    ...
    parser.add_argument('--test_dir', type=str, default='./Challenge2_Test_Task12_Images')
    parser.add_argument('--eval_dir', type=str, default='./eval/')
    parser.add_argument('--dataset', type=str, default='ICDAR 2013')
    #

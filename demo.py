...
def demo(args):
    ...
    for _, im_name in enumerate(ims_list):
        ...
        print("write image")
        print('./demo' + 'res_' + im_name)
        print(os.path.join('./demo' + 'res_' + im_name))
        cv2.imwrite('./demo/' + 'res_' + im_name  , im)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ims_dir', type=str, default='./Challenge2_Test_Task12_Images')
